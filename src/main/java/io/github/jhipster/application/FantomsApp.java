...
public class FantomsApp {

    private static final Logger log = LoggerFactory.getLogger(FantomsApp.class);

    private final Environment env;

    public FantomsApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FantomsApp.class);
